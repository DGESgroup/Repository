		...
		<div id="page">
			...
			<div id="content">
				<div id="content-inner">
					...
					<main id="contentbar">
						<div class="article">
							<h3 style='background:black;border:1px solid #ccc;font-size:120%;text-decoration:none;color:darkred;padding-right:300px; target='_blank'><i>Announcements</i></a></h3>
							<p>Enter announcements here</p>
							<h3 style='background:black;border:1px solid #ccc;font-size:120%;text-decoration:none;color:darkred;padding-right:300px; target='_blank'><i>Projects In-Progress</i></a></h3>
							<p>Java 1</p>
							<p>Java 2</p>
							<p>Java 3</p>
							<p>Java 4</p>
							<h3 style='background:black;border:1px solid #ccc;font-size:120%;text-decoration:none;color:darkred; padding-right:300px; target='_blank'><i>Projects of Interest</i></a></h3>
							<form>
					...
					<nav id="sidebar">
						<div class="widget">
							...
							<li><a href="#">Back to Student Portal	</a></li>
							</ul>
						</div>
					</nav>
